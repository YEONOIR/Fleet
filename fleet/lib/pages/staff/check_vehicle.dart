                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        String imgPath = ownerImages.isNotEmpty
                            ? ownerImages[index]
                            : '';
                                ...
                                MaterialPageRoute(
                                  builder: (_) => FullScreenImage(
                                    imageUrl: imgPath.startsWith('http')
                                        ? imgPath
                                        : null,
                                    imageAsset: !imgPath.startsWith('http')
                                        ? imgPath
                                        : null,
                                  ),
                                ),
                          ...
                          onConfirm: (String reason) async {
                            try {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text(
                                    'Request rejected and vehicle deleted.',
                              ...
                              Navigator.pushAndRemoveUntil(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => const StaffMainPage(),
                                ),
                                (route) => false,
                              );
                            } catch (e) {
