...
import 'vehicle_detail.dart'; // 💡 อย่าลืม import หน้า Detail ที่เราเพิ่งสร้างนะครับ
...
class _OwnerVehiclePageState extends State<OwnerVehiclePage> {
  ...
  final List<String> statusTypes = ['All', 'Available', 'Using', 'Pending', 'Unavailable'];
  ...
  },
  {
    ...
    "V Model": "Model 3",
    "V Type": "4 Door Car",
    "V Fuel": "EV", // 💡 Logic ของเราจะเปลี่ยนคำนี้เป็น 'ENERGY' อัตโนมัติ
    "V Address": "222 JJ village, Bangkok 10120",
    "V Price": 500.0,
    "V Deposit": 10000.0,
    "V Status": "Available", // 🟢 สถานะว่าง
    "V_Rate": 4.9,
    "imagePath": "assets/images/car.jpg",
    "statusColor": const Color(0xFF75DB73),
    "typeIcon": Icons.electric_car,
    "renterData": null // ว่างอยู่ ไม่มีคนเช่า
  },
  {
    ...
    "V Price": 200.0,
    "V Deposit": 500.0,
    "V Status": "Pending", // 🟠 สถานะรอตรวจสอบ
    "V_Rate": 4.2,
  ...
  },
  {
    ...
    "V Plate": "BB 567",
    "V Brand": "Yamaha",
    "V Model": "Grand Filano",
    "V Type": "Motorcycle",
    "V Fuel": "Sohol 91",
    "V Address": "333/33 Rama 9, Bangkok",
    "V Price": 150.0,
    "V Deposit": 1000.0,
    "V Status": "Unavailable", // 🔴 สถานะปิดการเช่า
    "V_Rate": 4.0,
    "imagePath": "assets/images/bike.jpg",
  ...
  Widget build(BuildContext context) {
    ...
    int availableCars = dummyVehicles.where((v) => v['V Status'] == 'Available').length;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () {
              // TODO: ไปหน้า Add Vehicle
            },
            icon: const Icon(Icons.add, color: Colors.white, size: 28),
          ),
          const SizedBox(width: 10), // เว้นระยะจากขอบจอนิดนึง
        ],
      ),
        ...
        children: [
          ...
          Expanded(
            child: filteredVehicles.isEmpty
                ? const Center(child: Text('No vehicles found.', style: TextStyle(fontFamily: 'Poppins', color: Colors.grey)))
                : ListView.builder(
                      ...
                      return GestureDetector(
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => VehicleDetailPage(vehicle: v),
                            ),
                          );
                        },
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(leading: const Icon(Icons.edit, color: Colors.blue), title: const Text('Edit Details'), onTap: () => Navigator.pop(context)),
            ListTile(leading: const Icon(Icons.delete_outline, color: Colors.red), title: const Text('Delete Vehicle', style: TextStyle(color: Colors.red)), onTap: () => Navigator.pop(context)),
          ],
        ),
      ),
    );
