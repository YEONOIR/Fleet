  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          IconButton(
            onPressed: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      const TakePhotoPage(vehicleName: 'New Vehicle'),
                ),
              );
            },
      ...
      body: user == null
          ? const Center(
              child: Text(
                "Please login to see your vehicles",
          ...
          : StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                List<Map<String, dynamic>> myVehicles = snapshot.data!.docs.map(
                  (doc) {
                    ...
                    if (statusStr == 'Using')
                      sColor = const Color.fromRGBO(172, 114, 161, 1.0);
                    else if (statusStr == 'Pending')
                      sColor = const Color(0xFFD39A3D);
                    else if (statusStr == 'Unavailable')
                      sColor = const Color(0xFFF07B75);
                ...
                int availableCars = myVehicles
                    .where((v) => v['V Status'] == 'Available')
                    .length;
                int usingCars = myVehicles
                    .where((v) => v['V Status'] == 'Using')
                    .length;
                ...
                List<Map<String, dynamic>> filteredVehicles =
                    ...
                    ? myVehicles
                    : myVehicles
                          .where((v) => v['V Status'] == selectedStatus)
                          .toList();
