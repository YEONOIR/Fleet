    ...
    return Scaffold(
              ...
              onPressed: () {
                if (status == 'using') {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text(
                        'Can not delete the vehicles. Please complete all rental arrangements first.',
                        style: TextStyle(
                          fontFamily: 'Poppins',
                          color: Colors.white,
                        ),
      ...
      body: Column(
        children: [
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            _buildInfoColumn(
                              'Deposit (฿)',
                              vehicle['V Deposit'].toString(),
                            ),
                            _buildInfoColumn(
                              'Price/Hour (฿)',
                              vehicle['V Price'].toString(),
                            ),
                          ],
                        ),
                        ...
                        // 6. USING
                        if (status == 'using')
                          _buildUsingInfo(context, galleryImages),
                      ],
                    ),
                  ),
                ],
          ...
          // 7. Action button based on status
            ...
            onPressed: () async {
              ...
              try {
                await FirebaseFirestore.instance
                    .collection('vehicles')
                    .doc(vehicleId)
                    .update({'status': 'pending', 'pending_type': 'Delete'});
