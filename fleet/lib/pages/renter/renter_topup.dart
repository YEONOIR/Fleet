  ...
  static const List<Map<String, dynamic>> _banks = [
    {
      ...
      'image': 'assets/images/bank_scb.jpg',
    },
    {
      'name': 'KBank',
      'color': Color(0xFF138D3B),
      'image': 'assets/images/bank_kbank.jpg',
    },
    {
      'name': 'BBL',
      'color': Color(0xFF1A3C8F),
      'image': 'assets/images/bank_bbl.png',
    },
    {
      'name': 'KTB',
      'color': Color(0xFF00A1E4),
      'image': 'assets/images/bank_ktb.png',
    },
    {
      'name': 'GSB',
      'color': Color(0xFFE91E63),
      'image': 'assets/images/bank_gsb.jpg',
    },
  ];
    ...
    try {
      ...
      if (user != null) {
        ...
        await FirebaseFirestore.instance
            .collection('users')
            .doc(user.uid)
            .update({'wallet_balance': FieldValue.increment(_selectedAmount!)});
        ...
        await FirebaseFirestore.instance.collection('notifications').add({
          ...
          'message':
              'Your wallet has been topped up with ฿$_selectedAmount via $bankName.',
          'is_read': false,
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(
                'Top up ฿$_selectedAmount successful via $bankName!',
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          onTap: () =>
              setState(() => _selectedBankIndex = isSelected ? null : index),
