...
class VehicleInfoCard extends StatelessWidget {
  ...
  final VoidCallback? onTap; // 💡 เพิ่มบรรทัดนี้เพื่อรับคำสั่งเมื่อถูกกด

  const VehicleInfoCard({
    super.key, 
    required this.data, 
    this.onTap, // 💡 รับค่าผ่าน Constructor
  });

  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: onTap, // 💡 สั่งให้ทำงานตามที่หน้าหลักส่งมา
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: const Color.fromRGBO(172, 114, 161, 0.6), // ขอบสีม่วง/ชมพู
            width: 1.5,
          ), 
        ),
        child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        data['rating']?.toString() ?? '0.0', // ใส่ ?.toString() กันจอแดง
                        style: const TextStyle(fontFamily: 'Poppins', fontSize: 15, fontWeight: FontWeight.bold, color: Colors.white),
                      ),
                    ],
                  ),
              ...
              child: Row(
                ...
                children: [
                  ...
                  ClipRRect(
                    ...
                    child: Image.asset(
                      data['image'] ?? 'assets/images/car.jpg',
                      width: 100,
                      height: 100,
                      fit: BoxFit.cover,
                      errorBuilder: (context, error, stackTrace) => Container(
                        width: 100, height: 100, color: Colors.grey.shade200, child: const Icon(Icons.directions_car, color: Colors.grey),
                      ),
                    ),
                  ),
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            const Icon(Icons.local_gas_station_outlined, size: 20, color: Colors.black87), // ไอคอนน้ำมัน
                          ],
                        ),
